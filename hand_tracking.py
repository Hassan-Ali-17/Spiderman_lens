...
def count_extended_fingers(hand_landmarks, w, h):
    """How many fingers are extended right now. A closed fist reads as 0-1
    (thumb detection is a little noisy), a fully open hand as 4-5."""
    return sum(get_extended_fingers(hand_landmarks, w, h).values())